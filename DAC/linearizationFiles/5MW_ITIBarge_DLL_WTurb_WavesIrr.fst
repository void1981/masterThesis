...
---------------------- INPUT FILES ---------------------------------------------
"Dyn_files/NRELOffshrBsline5MW_ITIBarge4_ElastoDyn.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
"Dyn_files/NRELOffshrBsline5MW_BeamDyn.dat"    BDBldFile(1)    - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"Dyn_files/NRELOffshrBsline5MW_BeamDyn.dat"    BDBldFile(2)    - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"Dyn_files/NRELOffshrBsline5MW_BeamDyn.dat"    BDBldFile(3)    - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
"Dyn_files/NRELOffshrBsline5MW_InflowWind_Steady18mps.dat"    InflowFile      - Name of file containing inflow wind input parameters (quoted string)
"Dyn_files/NRELOffshrBsline5MW_ITIBarge4_AeroDyn15.dat"    AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
"Dyn_files/NRELOffshrBsline5MW_ITIBarge4_ServoDyn.dat"    ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
"Dyn_files/NRELOffshrBsline5MW_ITIBarge4_HydroDyn.dat"    HydroFile       - Name of file containing hydrodynamic input parameters (quoted string)
"unused"      SubFile         - Name of file containing sub-structural input parameters (quoted string)
"Dyn_files/NRELOffshrBsline5MW_ITIBarge4_MAP.dat"    MooringFile     - Name of file containing mooring system input parameters (quoted string)
